    ...
    const projects: Project[] = [
        {
            ...
            github_url: "https://github.com/stoatchat",
            description: "Stoat is an open source user-first chat platform, built with Rust and Typescript it is an alternative to Discord."
        },
        {
            title:"Stoat Backend",
            tag:"Backend",
            tag_colour:"#9D4EDD",
            github_url:"https://github.com/stoatchat/stoatchat",
            description:"Backend for Stoat, handles crud operations, live events, and different types of external intergrations."
        },
        {
            title:"Stoat Rust SDK",
            tag:"Library",
            tag_colour:"#F64D00",
            github_url:"https://github.com/Zomatree/Highlight/tree/master/crates/stoat",
            url: "https://crates.io/crates/stoat-rs",
            description:"Rust API wrapper for Stoat."
        },
        {
            title: "Highlight",
            tag: "Stoat Bot",
            tag_colour: "#F64D00",
            github_url: "https://github.com/Zomatree/Highlight",
            description: "Stoat bot for custom trigger words and starboard channels, built in rust with stoat-rs."
        },
        {
            title: "Stoat iOS App",
            tag: "iOS Application",
            tag_colour: "#F05138",
            github_url: "https://github.com/stoatchat/for-ios",
            description: "iOS Application for Stoat, fully built with Swift and SwiftUI."
        },
        {
            title: "Zomatree.live",
            tag: "Website",
...
<svelte:head>
    <meta property="og:description" name="og:description" content="👋 I'm a programmer who works with Python, Rust and Typescript.">
    <meta property="description" name="description" content="👋 I'm a programmer who works with Python, Rust and Typescript.">
    <meta property="og:image" name="og:image" content={ og_image }>
    <meta property="og:title" name="og:title" content="Zomatree">
    <link rel="image_src" href= { og_image }>
    <meta property="twitter:card" name="twitter:card" content="summary_large_image">
    <meta property="theme-color" name="theme-color" content="#e0d5ff">
    <meta property="og:site_name" name="og:site_name" content="Zomatree">
</svelte:head>
